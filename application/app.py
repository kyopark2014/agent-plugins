...
# title
st.set_page_config(page_title='agent-plugins', page_icon=None, layout="centered", initial_sidebar_state="auto", menu_items=None)
...
with st.sidebar:
    ...
    st.markdown(
        ...
        "상세한 코드는 [Github](https://github.com/kyopark2014/agent-   )을 참조하세요."
    )
